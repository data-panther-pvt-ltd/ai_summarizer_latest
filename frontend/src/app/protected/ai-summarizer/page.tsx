...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="border-b border border-gray-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
          ...
          <aside className="bg-white rounded-xl shadow-sm p-6 h-fit">
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  className="w-full p-3 border border-gray-300 text-gray-900 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  value={model}
                ...
                <p className="mt-2 text-xs text-gray-500">OpenAI requires `OPENAI_API_KEY` in backend environment.</p>
              </div>
              ...
              <div>
                ...
                <select
                  className="w-full p-3 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  value={style}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              {activeTab === "text" && (
                <div>
                  ...
                  <textarea
                    className="w-full h-56 p-4 border border-gray-300 text-gray-500 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
